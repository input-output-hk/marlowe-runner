...
(0, _cucumber.Then)(/^I should (not |)see a "([^"]*)" with "([^"]*)" text$/, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(negate, role, name) {
    var page;
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  return _context.abrupt("return", (0, _test.expect)(locator.count()).toEqual(0));
                case 7:
                  _context.next = 9;
