...
var _globalStateManager = _interopRequireDefault(require("../../support/globalStateManager"));
var _walletConfiguration = require("../../support/walletConfiguration");
...
var ScenarioWorld = /*#__PURE__*/function (_World) {
  ...
  function ScenarioWorld(options) {
    ...
    _defineProperty(_assertThisInitialized(_this), "globalStateManager", new _globalStateManager["default"]());
    _defineProperty(_assertThisInitialized(_this), "newContext", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var automationBrowsers, automationBrowser, pathToExtension, browserType, context;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            automationBrowsers = ['chromium', 'firefox', 'webkit'];
            automationBrowser = (0, _parseEnv.env)('UI_AUTOMATION_BROWSER');
            pathToExtension = (0, _parseEnv.env)('LACE_WALLET_EXTENSION_PATH');
            browserType = _playwright["default"][automationBrowser];
            _context.next = 6;
            return browserType.launchPersistentContext('', {
              devtools: process.env.DEVTOOLS !== 'false',
              headless: process.env.HEADLESS !== 'false',
              args: ['--no-sandbox', '--disable-gpu', '--disable-notifications', '--enable-automation', '--no-first-run', '--no-default-browser-check', "--disable-extensions-except=".concat(pathToExtension), "--load-extension=".concat(pathToExtension), '--disable-web-security', '--allow-insecure-localhost', '--window-size=1920,1080', '--allow-file-access-from-files', '--disable-dev-shm-usage', '--remote-allow-origins=*', '--disable-features=IsolateOrigins, site-per-process']
            });
          case 6:
  ...
  _createClass(ScenarioWorld, [{
    ...
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(contextOptions) {
        var _this$screen, _this$screen$page, _this$screen2, _this$screen2$context;
        var context, page, EXTENSION_URL;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              page = _context2.sent;
              EXTENSION_URL = 'chrome-extension://gafhhkghbfjjkeiendhlofajokpaflmk';
              _context2.next = 13;
              return page["goto"]("".concat(EXTENSION_URL, "/app.html"));
            case 13:
              _context2.next = 15;
              return page.addInitScript(function (testWallet) {
                var _testWallet$backgroun, _testWallet$backgroun2;
                ...
                var keyAgentData = JSON.parse(testWallet === null || testWallet === void 0 ? void 0 : (_testWallet$backgroun = testWallet.backgroundStorage) === null || _testWallet$backgroun === void 0 ? void 0 : _testWallet$backgroun.keyAgentsByChain);
                var mnemonicData = JSON.parse(testWallet === null || testWallet === void 0 ? void 0 : (_testWallet$backgroun2 = testWallet.backgroundStorage) === null || _testWallet$backgroun2 === void 0 ? void 0 : _testWallet$backgroun2.mnemonic);
                var backgroundStorage = {
              ...
              }, _walletConfiguration.testWallet);
            case 15:
              _context2.next = 17;
              return page["goto"]("".concat(EXTENSION_URL, "/app.html"));
            case 17:
