...
var _navigationBehavior = require("../support/navigation-behavior.js");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log("I am on the ".concat(pageId, " page application"));
          _context.next = 4;
...
(0, _cucumber.Then)('a new browser tab should open for {string} at {string} url', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, expectedUrl) {
    var globalStateManager, newPage;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          globalStateManager = this.globalStateManager;
          newPage = globalStateManager.getValue(name);
          _context3.next = 4;
          return (0, _waitForBehavior.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return newPage.waitForLoadState();
                case 2:
                  // Get the URL of the new page
                  actualUrl = newPage.url(); // Close the new page
                  _context2.next = 5;
                  return newPage.close();
                case 5:
                  return _context2.abrupt("return", actualUrl.includes(expectedUrl));
                case 6:
                case "end":
